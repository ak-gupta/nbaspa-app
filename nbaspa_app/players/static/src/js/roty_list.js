/**
 * @module roty Code for generating a paginated list of the top rookies in a given season.
 */
 ...
 class ROtYList {
    ...
    async loadData(page=1) {
        ...
        this.top = axios.get($SCRIPT_ROOT + "/api/league/roty", {
            params: {
                "Season": this.Season,
                "mode": this.mode,
                "sortBy": this.sortBy,
    ...
    async createPagination() {
        ...
        if ("previous_page" in headers) {
            nav.insert("a")
                ...
                .attr(
                    "href",
                    $SCRIPT_ROOT + "/season/roty/" + this.Season +  "/" + headers["previous_page"] + queryParams
                )
                .text("Previous")
        }
        if ("next_page" in headers) {
            nav.insert("a")
                ...
                .attr(
                    "href", $SCRIPT_ROOT + "/season/roty/" + this.Season + "/" + headers["next_page"] + queryParams
                )
                .text("Next")
            ...
            pageList.insert("li")
                ...
                .attr("href", $SCRIPT_ROOT + "/season/roty/" + this.Season + "/1" + queryParams)
                .text(1)
            if (!("previous_page" in headers) || (headers["page"] <= 3)) {
                pageList.insert("li")
                    .insert("a")
                    .classed("pagination-link", true)
                    .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/2" + queryParams)
                    .text(2)
                pageList.insert("li")
                    .insert("a")
                    .classed("pagination-link", true)
                    .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/3" + queryParams)
                    .text(3)
            } else {
                pageList.insert("li")
                    .insert("span")
            ...
            if ((headers["page"] > 3) && (headers["page"] < headers["total_pages"] - 1)) {
                pageList.insert("li")
                    .insert("a")
                    .classed("pagination-link", true)
                    .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/" + headers["previous_page"] + queryParams)
                    .text(headers["previous_page"])
                pageList.insert("li")
                    .insert("a")
                    .classed("pagination-link", true)
                    .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/" + headers["page"] + queryParams)
                    .text(headers["page"])
                pageList.insert("li")
                    .insert("a")
                    .classed("pagination-link", true)
                    .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/" + headers["next_page"] + queryParams)
            ...
            if (headers["page"] == headers["total_pages"] - 1) {
                ...
                pageList.insert("li")
                    ...
                    .classed("pagination-link", true)
                    .attr(
                        "href", $SCRIPT_ROOT + "/season/roty/" + Season + "/" + headers["total_pages"] + queryParams
                    )
            ...
            pageList.insert("li")
                .insert("a")
                .classed("pagination-link", true)
                .attr("href", $SCRIPT_ROOT + "/season/roty/" + Season + "/1" + queryParams)
                .text(1)
            pageList.insert("li")
                .insert("span")
                .classed("pagination-ellipsis", true)
